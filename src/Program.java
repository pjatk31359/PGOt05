public class Program {
    public static void main(String[] args) {
        ...
        myLibrary.searchTracks("Queen - Bohemian Rhapsody");

        myLibrary.removeTrack("Ac/DC - Back in Black");

        myLibrary.displayPlaylist("Party");

        System.out.println("Total number of tracks in the library: "+ myLibrary.getTrackCount("Queen - Bohemian Rhapsody"));
        System.out.println("Total number of playlists in the library: "+ myLibrary.getPlaylistCount("Party"));
